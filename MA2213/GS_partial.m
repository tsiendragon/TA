function x =  GS_partial(A,b,digit,type)
%%  function to perform the Gauss elimination with partial
...
if ~exist('digit','var') % the default value for digit
    digit = 4;
end
if ~exist('type','var') % by default, using rouding arithmatic
